...
public class PromptDialogExit extends Dialog {
    ...
    public interface OnNegativeListener {
        void onClick(PromptDialogExit promptDialog);
    }
    ...
    public PromptDialogExit(Context context) {
        this(context, 0);
    }

    public PromptDialogExit(Context context, int theme) {
    ...
    private int getColorResId(int mDialogType) {
        if (mDialogType == 0) {
            return R.color.color_type_bluedark;
        }
        if (mDialogType == 0) {
    ...
    private void initAnimListener() {
        this.mAnimOut.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                PromptDialogExit.this.mDialogView.post(new Runnable() {
                    public void run() {
                        PromptDialogExit.this.callDismiss();
                    }
                });
            }
    ...
    private void initListener() {
        this.mPositiveBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (PromptDialogExit.this.mOnPositiveListener != null) {
                    PromptDialogExit.this.mOnPositiveListener.onClick(PromptDialogExit.this);
                }
            }
        });
        this.mNegativeBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (PromptDialogExit.this.mOnNegativeListener != null) {
                    PromptDialogExit.this.mOnNegativeListener.onClick(PromptDialogExit.this);
                }
            }
        });
        initAnimListener();
    ...
    private void setBtnBackground(TextView btnOk) {
        btnOk.setTextColor(createColorStateList(getContext().getResources().getColor(R.color.white),
    ...
    public PromptDialogExit setAnimationEnable(boolean enable) {
        this.mIsShowAnim = enable;
        return this;
    }

    public PromptDialogExit setTitleText(CharSequence title) {
        this.mTitle = title;
        return this;
    }

    public PromptDialogExit setTitleText(int resId) {
        return setTitleText(getContext().getString(resId));
    }

    public PromptDialogExit setContentText(CharSequence content) {
        this.mContent = content;
        return this;
    }

    public PromptDialogExit setContentText(int resId) {
    ...
    public PromptDialogExit setDialogType(int type) {
        this.mDialogType = type;
        return this;
    }

    public PromptDialogExit setPositiveListener(CharSequence btnText, OnPositiveListener l) {
        this.mBtnText = btnText;
        return setPositiveListener(l);
    }

    public PromptDialogExit setNegativeListener(CharSequence btnText, OnNegativeListener l) {
        this.mNegative = btnText;
        return setNegativeListener(l);
    }

    public PromptDialogExit setPositiveListener(int stringResId, OnPositiveListener l) {
        return setPositiveListener(getContext().getString(stringResId), l);
    }

    public PromptDialogExit setNegativeListener(int stringResId, OnNegativeListener l) {
        return setNegativeListener(getContext().getString(stringResId), l);
    }

    public PromptDialogExit setPositiveListener(OnPositiveListener l) {
        this.mOnPositiveListener = l;
        return this;
    }

    public PromptDialogExit setNegativeListener(OnNegativeListener l) {
        this.mOnNegativeListener = l;
        return this;
    }

    public PromptDialogExit setAnimationIn(AnimationSet animIn) {
        this.mAnimIn = animIn;
        return this;
    }

    public PromptDialogExit setAnimationOut(AnimationSet animOut) {
