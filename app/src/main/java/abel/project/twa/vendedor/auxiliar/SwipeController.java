...
public class SwipeController extends Callback {
                ...
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    if (buttonsActions != null && buttonInstance != null && buttonInstance.contains(event.getX(), event.getY())) {
                        if (buttonShowedState == ButtonsState.LEFT_VISIBLE) {
                            ...
                            System.out.println("!!!!!!!!!!!!!!!!!!! LEFTTT "+viewHolder.getAdapterPosition());
                        }
                        else if (buttonShowedState == ButtonsState.RIGHT_VISIBLE) {
                            buttonsActions.onRightClicked(viewHolder.getAdapterPosition());
                            System.out.println("!!!!!!!!!!!!!!!!!!! RIGHT "+viewHolder.getAdapterPosition());
                        }
                    }
    ...
    private void drawButtons(Canvas c, RecyclerView.ViewHolder viewHolder) {
        ...
        if (buttonShowedState == ButtonsState.LEFT_VISIBLE) {
            ...
            p.setColor(Color.parseColor("#90b06e"));
            c.drawRoundRect(leftButton, corners, corners, p);
            drawText(viewHolder.itemView.getResources().getString(R.string.edit), c, leftButton, p);
        }
        ...
        if (buttonShowedState == ButtonsState.RIGHT_VISIBLE) {
            ...
            p.setColor(Color.parseColor("#ed7861"));
            c.drawRoundRect(rightButton, corners, corners, p);
            drawText(viewHolder.itemView.getResources().getString(R.string.delete), c, rightButton, p);
        }
