    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < numberOfCameras; i++) {
            ...
            if(info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
                cameraNames[i] = "Frontal";
            } else if(info.facing == Camera.CameraInfo.CAMERA_FACING_BACK) {
                cameraNames[i] = "Trasera";
            } else {
        ...
        builder.setTitle(R.string.select_camera)
                ...
                .setPositiveButton(R.string.ok_button, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if(info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
                            PreferenceManager.getDefaultSharedPreferences(getActivity()).getString("camera","frontal");
                        } else if(info.facing == Camera.CameraInfo.CAMERA_FACING_BACK) {
                            PreferenceManager.getDefaultSharedPreferences(getActivity()).getString("camera","trasera");
                        } else {
                            PreferenceManager.getDefaultSharedPreferences(getActivity()).getString("camera","frontal");
                        }*/
                    }
